...
import {
  ...
  Plus, RefreshCw, Save, Search, ShieldCheck, Users, X,
} from "lucide-react";
...
function GuideView() {
  const tasks = [
    ...
    ["Change page headings", "Open Page Headings. Hide, rename or resize a heading for an exact route such as /contact or a route group such as /divisions/*."],
